...
async def getArticle(coinName):
    ...
    async with httpx.AsyncClient(headers=headers) as client:
        ...
        html = response.text
        soup = bs(html, 'lxml')
        titleList = soup.select('.searchSectionMain .title')
